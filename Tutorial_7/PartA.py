# ENEE408I - Tutorial 7 - Part A

# Author: Kent Chesley
# Date: 10-19-2023

# Reference: https://dontrepeatyourself.org/post/yolov3-object-detection-with-deep-learning-opencv-and-python/.
...
image = cv2.imread("YOLOv3-Object-Detection-with-Deep-Learning-OpenCV-and-Python-main/examples/images/1.jpg")
...
classes_path = "YoloV3/coco.names"
...
# Changed "i[1] - 1" to "i - 1" to avoid issue that. Daniel said this is necessary because different versions of 
# OpenCV use different numbers of array dimmensions.
